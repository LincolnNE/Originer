...
export class PromptAssembler {
  ...
  private formatMessageHistory(
    ...
    // Preserve caller order (session messageIds / loadMessages order). Sorting by
    // timestamp would scramble history when timestamps are out of order vs. conversation.
